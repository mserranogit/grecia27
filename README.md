...
Planificador integral, logística y aplicación web interactiva para el viaje a Grecia del 1 al 20 de Junio de 2027 (20 días).
...
- **[`web/`](./web/)**: Aplicación web interactiva responsive (HTML5, Vanilla CSS, JS moderno, mapas con Leaflet y Google Maps sin API Key).
  - Selector interactivo de días (1 al 20) e islas (8 islas clave).
